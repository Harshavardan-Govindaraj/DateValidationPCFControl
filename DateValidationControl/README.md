...
![Date Validation PCF Control](images/date-control.png)
...
![Date Validation Configuration - Part 1](images/configuration-1.png)

![Date Validation Configuration - Part 2](images/configuration-2.png)
